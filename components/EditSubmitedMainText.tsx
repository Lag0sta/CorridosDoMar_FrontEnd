...
const EditSubmitedMainText = ({ type, selectedType, setSelectedType, editedText, setEditedText, indexToRemove, setIndexToRemove, setIsModalOpen, }: Props) => {

    console.log("selectedType", selectedType)
    const dispatch = useDispatch();
    const textToEdit = useAppSelector((state) => state.editSubmit.value.mainText)
...
export default EditSubmitedMainText
